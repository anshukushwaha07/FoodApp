const FoodCard = ({ title, price, description, rating, reviews, image, badge, badgeColor }) => (
  <div className="group flex flex-col bg-surface-light dark:bg-surface-dark rounded-2xl overflow-hidden border border-border-light dark:border-border-dark shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-300">
    ...
    <div className="p-5 flex flex-col flex-1">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <button className="bg-surface-light dark:bg-[#3a2d29] hover:bg-primary hover:text-white text-primary border border-primary/20 hover:border-primary px-4 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2">
